...
exports.sources = exports.twitterSearchSources = void 0;
...
function getSourceById(id) {
    return exports.sources.find((s) => s.id === id);
}
function getSourcesByJurisdiction(country) {
    return exports.sources.filter((s) => s.jurisdictionCountry === country);
}
function getSourcesByTier(minTier) {
    return exports.sources.filter((s) => s.reliabilityTier >= minTier);
}
